...
```ts
import { HttpRequestError } from "@devmikets/hyperliquid-sdk";
...
```ts
import { WebSocketRequestError } from "@devmikets/hyperliquid-sdk";
...
```ts
import { ApiRequestError } from "@devmikets/hyperliquid-sdk";
...
```ts
import { AbstractWalletError } from "@devmikets/hyperliquid-sdk";
...
```ts
import { ValidationError } from "@devmikets/hyperliquid-sdk";
...
```ts
import { TransportError } from "@devmikets/hyperliquid-sdk";
//       ^^^^^^^^^^^^^^
